...
browser = webdriver.Chrome("C:/Users/Owner/Desktop/Programs/Python-files/ARB/chromedriver.exe")         #webdriver file location needs to be changed in order to match with current pc
...
async def on_message(message):
    ...
    if message.channel.name == 'bot-test':
        if user_message.lower() == 'hello':
            ...
            return
        elif user_message.lower() == '!animesux':
            ...
            #browser.get(url)
            #browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[3]/div[2]/div[2]/div[1]/div/article[1]/div[1]/div[2]/div[1]/a[1]').click()
            page = requests.get(url)
            soup = BeautifulSoup(page.text, "html.parser")
            #result = soup.find("class")
